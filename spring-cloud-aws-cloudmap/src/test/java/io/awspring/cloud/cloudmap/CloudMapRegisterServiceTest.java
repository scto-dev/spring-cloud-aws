...
public class CloudMapRegisterServiceTest {
	...
	public void cloudMapRegisterInstancesNameSpaceAndServiceExists() {
		...
		assertThat(cloudMapUtils.registerInstance(serviceDiscovery, ec2Client, getProperties(), environment, ECS))
				.isNotEmpty();
	}
	...
	public void cloudMapRegisterInstanceEksWithNoNameSpace() {
		...
		assertThat(cloudMapUtils.registerInstance(serviceDiscovery, ec2Client, getProperties(), environment, EKS))
				.isNotEmpty();
	}
